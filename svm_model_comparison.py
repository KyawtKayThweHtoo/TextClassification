...
class SVMComparisonApp:
    ...
    def update_visualization(self):
        ...
        # Create a color map
        colors = list(mcolors.TABLEAU_COLORS)[:len(categories)]
        ...
        for i, cat in enumerate(categories):
            ...
            if len(cat_idx) > 0:
                ...
                linear_class_acc.append(cat_acc)
            else:
                linear_class_acc.append(0)
        ...
        for i, cat in enumerate(categories):
            ...
            if len(cat_idx) > 0:
                ...
                poly_class_acc.append(cat_acc)
            else:
                poly_class_acc.append(0)
        
        # Create bar chart
        self.ax.bar(x - width/2, linear_class_acc, width, label='Linear SVM')
        self.ax.bar(x + width/2, poly_class_acc, width, label='Polynomial SVM')
        
        # Add labels and title
        self.ax.set_xlabel('Category')
        self.ax.set_ylabel('Accuracy')
        self.ax.set_title('SVM Model Comparison by Category')
